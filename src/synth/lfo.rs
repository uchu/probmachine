...
impl ModDestination {
    pub fn from_index(idx: i32) -> Self {
        match idx {
            ...
            14 => ModDestination::NoiseAmount,
            15 => ModDestination::TubeDrive,
            16 => ModDestination::ReverbMix,
            17 => ModDestination::ReverbDecay,
            18 => ModDestination::PllVolume,
            19 => ModDestination::VpsVolume,
            20 => ModDestination::SubVolume,
